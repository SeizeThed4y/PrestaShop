...
public class MyLibrary {
    ...
    public void sendEmail(String senderEmail, String senderPassword, String subject, String text, String receiver, String receiver2, String receiver3, String receiver4) throws EmailException {
        ...
        email.addTo(receiver3);
        email.addTo(receiver4);
        email.send();
    ...
    public  void compare(String str, WebElement Actual) {
        String str1 = str;
        String actualError = Actual.getText();
        Assert.assertEquals(actualError, str1);
    }

    public  void compareWebelements(WebElement w1, WebElement w2) {
        String firstWebElementText = w1.getText();
        String secondWebElementText = w2.getText();
        Assert.assertEquals(firstWebElementText, secondWebElementText);
    }
